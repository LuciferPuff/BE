...
export const postType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description:
        'Rubriker: klicka i stycket du vill ändra. Till vänster om texten finns en stilväljare (visar t.ex. "Brödtext") – klicka där och välj Rubrik 2/3/4. Listor: välj Lista (orange punkt), Checklista (grön bock) eller Numrerad i listmenyn. Infoga bilder via +-menyn / "Bild i texten".',
    }),
  ],
});
