...
1975–1985:
- Påreglat trägolv direkt på betongplatta: den vanligaste och viktigaste
  risken i perioden. Träet suger upp fukt från betongen underifrån, vilket
  ger mögel och röta över tid.
- Platta på mark med ingjuten isolering: tätskikt kan vara bristfälligt och
  förvärra fuktproblem, men huvudrisken är ofta organiskt material mot betong.
- Plastmatta på betongplatta: relevant risk enbart där det faktiskt är betong.
  För badrum på övre plan ska du först identifiera bjälklagstyp.
...
- Om huset har solceller och taket inte är dokumenterat bytt: om taket behöver
  bytas måste solcellerna monteras ned och sedan upp igen. Det tillkommer som
  extra kostnad utöver takets byte. Fråga alltid om taket är bytt efter
  solcellsinstallationen.
- Solceller producerar mest el på sommaren och under dagtid – när elpriset
  ofta är lågt. Köpt el behövs främst på vintern och kvällar – när elpriset
  ofta är högt. Räkna inte med att solcellerna täcker en stor del av
  vinterförbrukningen.
- Dränering i perioden är främst kritisk för hus med källare eller krypgrund.
  Saknas källare och krypgrund är dräneringen sekundär – fokusera på platta och
  grund istället.
...
- Om annonsen bara säger "mekanisk till- och frånluft" utan värmeåtervinning:
  skriv inte FTX. Använd "mekanisk ventilation (FT eller FTX – kontrollera
  vilket)".
...
- Dränering: nämns nästan aldrig. Om inte omgjord senaste 30 åren = stor risk
  främst vid källare eller krypgrund. Byte: 150 000–400 000 kr.
  Saknas källare och krypgrund är dräneringen sekundär – fokusera på platta och
  grund istället.
...
9. Förutsätt aldrig betongbjälklag på övre plan om det inte framgår av
   annonsen – standardantagande är träbjälklag.
10. Varning om plastmatta på betong gäller bara där bjälklaget/plattan faktiskt
    är av betong. Vid sannolikt träbjälklag: fokusera på tätskiktets ålder och
    risk för vattenläckage ned i träbjälklaget.
11. Skriv aldrig FTX om det inte explicit framgår att systemet har
    värmeåtervinning. Standardterm om okänt: "mekanisk ventilation (FT eller
    FTX – kontrollera vilket)".
